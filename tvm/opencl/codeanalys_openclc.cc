...
void CodeAnalysOpenCLC::Init() {
    ;
}

void CodeAnalysOpenCLC::InitFuncState(LoweredFunc f) {
  alloc_storage_scope_.clear();
  handle_data_type_.clear();
  map_arg_type_.clear();
  CodeGenSourceBase::ClearFuncState();
}
void CodeAnalysOpenCLC::AddFunction(LoweredFunc f) {
...
str2tupleMap<std::string, Type> CodeAnalysOpenCLC::Finish() {
  return this->map_arg_type_;
}

void CodeAnalysOpenCLC::PrintExpr(const Expr& n, std::ostream& os) {  // NOLINT(*)
  VisitExpr(n, os);
}

void CodeAnalysOpenCLC::PrintSSAAssign(
...
std::string CodeAnalysOpenCLC::GetBufferRef(
...
// Print a reference expression to a buffer.
std::string CodeAnalysOpenCLC::GetStructRef(
...
bool CodeAnalysOpenCLC::HandleTypeMatch(const Variable* buf_var, Type t) const {
  auto it = handle_data_type_.find(buf_var);
  if (it == handle_data_type_.end()) return false;
  return it->second == t;
}

void CodeAnalysOpenCLC::RegisterHandleType(const Variable* buf_var, Type t) {
  auto it = handle_data_type_.find(buf_var);
...
void CodeAnalysOpenCLC::PrintVecElemLoad(const std::string& vec,
                                Type t, int i,
                                std::ostream& os) {  // NOLINT(*)
  os << vec << ".s" << std::hex << i << std::dec;
}

void CodeAnalysOpenCLC::PrintVecElemStore(const std::string& vec,
                                 Type t, int i,
...
std::string CodeAnalysOpenCLC::GetVecLoad(
    Type t, const Variable* buffer, Expr base) {
  return GetBufferRef(t, buffer, base);
}

void CodeAnalysOpenCLC::PrintVecStore(const Variable* buffer,
                             Type t, Expr base,
                             const std::string& value) {
...
std::string CodeAnalysOpenCLC::CastFromTo(std::string value, Type from, Type target) {
...
void CodeAnalysOpenCLC::BindThreadIndex(const IterVar& iv) {
  LOG(FATAL) << "not implemented";
}

void CodeAnalysOpenCLC::PrintStorageSync(const Call* op) { // NOLINT(*)
}

void CodeAnalysOpenCLC::PrintStorageScope(const std::string& scope, std::ostream& os) { // NOLINT(*)
  CHECK_EQ(scope, "global");
}

std::string CodeAnalysOpenCLC::GetType(Type t) { // NOLINT(*)
  std::ostringstream os;
  PrintType(t, os);
  return os.str();
}

void CodeAnalysOpenCLC::PrintType(Type t, std::ostream& os) {  // NOLINT(*)
  CHECK_EQ(t.lanes(), 1)
...
inline void PrintConst(const IntImm* op, std::ostream& os, CodeAnalysOpenCLC* p) { // NOLINT(*)
  if (op->type == Int(32)) {
...
inline void PrintConst(const UIntImm* op, std::ostream& os, CodeAnalysOpenCLC* p) { // NOLINT(*)
  if (op->type == UInt(32)) {
    std::ostringstream temp;
    temp << op->value << "U";
    p->MarkConst(temp.str());
...
inline void PrintConst(const FloatImm* op, std::ostream& os, CodeAnalysOpenCLC* p) { // NOLINT(*)
  switch (op->type.bits()) {
    case 64: case 32: {
      std::ostringstream temp;
...
void CodeAnalysOpenCLC::VisitExpr_(const IntImm *op, std::ostream& os) {  // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const UIntImm *op, std::ostream& os) {  // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const FloatImm *op, std::ostream& os) { // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const StringImm *op, std::ostream& os) { // NOLINT(*)
  os << "\"" << op->value << "\"";
}
...
void CodeAnalysOpenCLC::VisitExpr_(const Cast *op, std::ostream& os) {  // NOLINT(*)
  std::stringstream value;
  this->PrintExpr(op->value, value);
  os << CastFromTo(value.str(), op->value.type(), op->type);
}
void CodeAnalysOpenCLC::VisitExpr_(const Variable *op, std::ostream& os) {  // NOLINT(*)
  os << GetVarID(op);
}
void CodeAnalysOpenCLC::VisitExpr_(const Add *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "+", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Sub *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "-", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Mul *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "*", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Div *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "/", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Mod *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "%", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Min *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "min", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Max *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "max", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const EQ *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "==", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const NE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "!=", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const LT *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "<", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const LE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "<=", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const GT *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, ">", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const GE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, ">=", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const And *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "&&", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Or *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "||", os, this);
}
void CodeAnalysOpenCLC::VisitExpr_(const Not *op, std::ostream& os) {  // NOLINT(*)
  os << '!';
  PrintExpr(op->a, os);
}

void CodeAnalysOpenCLC::VisitExpr_(const Call *op, std::ostream& os) {  // NOLINT(*)
...
void CodeAnalysOpenCLC::PrintVecBinaryOp(
...
void CodeAnalysOpenCLC::VisitExpr_(const Load* op, std::ostream& os) {  // NOLINT(*)
...
void CodeAnalysOpenCLC::VisitStmt_(const Store* op) {
...
void CodeAnalysOpenCLC::VisitExpr_(const Let* op, std::ostream& os) {  // NOLINT(*)
  std::string value = PrintExpr(op->value);
  CHECK(!var_idmap_.count(op->var.get()));
  var_idmap_[op->var.get()] = value;
}

void CodeAnalysOpenCLC::VisitExpr_(const Ramp* op, std::ostream& os) {  // NOLINT(*)
...
void CodeAnalysOpenCLC::VisitExpr_(const Broadcast* op, std::ostream& os) {   // NOLINT(*)
  LOG(FATAL) << "Broadcast: not supported ";
}

void CodeAnalysOpenCLC::VisitExpr_(const Select* op, std::ostream& os) {  // NOLINT(*)
  os << "(";
...
void CodeAnalysOpenCLC::VisitExpr_(const GetBit *op, std::ostream& os) { // NOLINT(*)
  os << "(";
  PrintExpr(op->a, os);
  os << " & (1 << (";
...
void CodeAnalysOpenCLC::VisitExpr_(const GetSlice *op, std::ostream& os) { // NOLINT(*)
...
void CodeAnalysOpenCLC::VisitExpr_(const SetBit *op, std::ostream& os) { // NOLINT(*)
  os << "(";
  PrintExpr(op->a, os);
  os << " | (1 << (";
  PrintExpr(op->index, os);
...
void CodeAnalysOpenCLC::VisitExpr_(const SetSlice *op, std::ostream& os) { // NOLINT(*)
...
void CodeAnalysOpenCLC::VisitExpr_(const Quantize *op, std::ostream& os) { // NOLINT(*)
 LOG(FATAL) << "Quantize is not yet support";
}

void CodeAnalysOpenCLC::VisitExpr_(const KernelExpr *op, std::ostream& os) { // NOLINT(*)
  LOG(FATAL) << "KernelExpr is not yet support";
}


void CodeAnalysOpenCLC::VisitStmt_(const LetStmt* op) {
  // TODO comaniac
...
void CodeAnalysOpenCLC::VisitStmt_(const Allocate* op) {
...
void CodeAnalysOpenCLC::VisitStmt_(const AttrStmt* op) {
...
void CodeAnalysOpenCLC::VisitStmt_(const AssertStmt* op) {
...
void CodeAnalysOpenCLC::VisitStmt_(const For* op) {
...
void CodeAnalysOpenCLC::VisitStmt_(const IfThenElse* op) {
  std::string cond = PrintExpr(op->condition);
  PrintIndent();
...
void CodeAnalysOpenCLC::VisitStmt_(const Block *op) {
  PrintStmt(op->first);
  if (op->rest.defined()) PrintStmt(op->rest);
}

void CodeAnalysOpenCLC::VisitStmt_(const Evaluate *op) {
...
void CodeAnalysOpenCLC::VisitStmt_(const ProducerConsumer *op) {
  PrintStmt(op->body);
}

void CodeAnalysOpenCLC::VisitStmt_(const KernelDef *op) {
  LOG(FATAL) << "KernelDef is not yet support";
}

void CodeAnalysOpenCLC::VisitStmt_(const KernelStmt *op) {
  LOG(FATAL) << "KernelStmt is not yet support";
}

void CodeAnalysOpenCLC::VisitStmt_(const Return *op) {
  this->stream << "return ";
  PrintExpr(op->value);
  this->stream << ";\n";
}

void CodeAnalysOpenCLC::VisitStmt_(const Break *op) {
  // TODO: Check if the break statement is used correctly
  this->stream << "break;\n";
}

void CodeAnalysOpenCLC::VisitStmt_(const While *op) {
...
void CodeAnalysOpenCLC::VisitStmt_(const Reuse *op) {
  LOG(FATAL) << "KernelDef is not yet support";
}

void CodeAnalysOpenCLC::VisitStmt_(const Partition *op) {}

void CodeAnalysOpenCLC::VisitStmt_(const Stencil *op) {
  PrintStmt(op->body);
}
