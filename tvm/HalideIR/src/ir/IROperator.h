...
inline Expr cast(Type t, const Expr &a) {
  ...
  if (t.is_vector()) {
    if (a.type().is_scalar()) {
      ...
      return Internal::Broadcast::make(cast(t.element_of(), b->value),
                                       t.lanes());
    }
  }
...
inline Expr operator&&(const Expr &a, bool b) {
  ...
  internal_assert(a.type().is_bool())
      << "operator&& of Expr of type " << a.type() << "\n";
  if (b) {
    return a;
  } else {
...
inline Expr operator&&(bool a, const Expr &b) { return b && a; }
// @}
...
inline Expr operator!(const Expr &a) { return Internal::Not::make(a); }
...
template <typename A, typename B, typename C, typename... Rest,
          typename std::enable_if<Halide::Internal::all_are_convertible<
              Expr, Rest...>::value>::type * = nullptr>
...
inline Expr select(Expr condition, Expr true_value, Expr false_value) {
  if (as_const_int(condition)) {
    // Why are you doing this? We'll preserve the select node until constant
    // folding for you.
  ...
  user_assert(true_value.type() == false_value.type())
      << "The second and third arguments to a select do not have a matching "
         "type:\n"
...
template <typename... Args,
          typename std::enable_if<Halide::Internal::all_are_convertible<
              Expr, Args...>::value>::type * = nullptr>
inline Expr select(const Expr &c0, const Expr &v0, const Expr &c1,
                   const Expr &v1, Args &&... args) {
...
inline Expr sin(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "sin_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "sin_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "sin_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr asin(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "asin_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "asin_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "asin_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr cos(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "cos_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "cos_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "cos_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr acos(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "acos_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "acos_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "acos_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr tan(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "tan_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "tan_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "tan_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr atan(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "atan_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "atan_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "atan_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr atan2(Expr y, Expr x) {
  ...
  if (y.type() == Float(64)) {
    x = cast<double>(x);
    return Internal::Call::make(Float(64), "atan2_f64", {y, x},
                                Internal::Call::PureExtern);
  } else if (y.type() == Float(16)) {
    x = cast<float16_t>(x);
    return Internal::Call::make(Float(16), "atan2_f16", {y, x},
                                Internal::Call::PureExtern);
  } else {
    y = cast<float>(y);
    x = cast<float>(x);
    return Internal::Call::make(Float(32), "atan2_f32", {y, x},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr sinh(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "sinh_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "sinh_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "sinh_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr asinh(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "asinh_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "asinh_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "asinh_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr cosh(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "cosh_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "cosh_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "cosh_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr acosh(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "acosh_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "acosh_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "acosh_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr tanh(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "tanh_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "tanh_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "tanh_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr atanh(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "atanh_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "atanh_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "atanh_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr sqrt(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "sqrt_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "sqrt_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "sqrt_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr hypot(const Expr &x, const Expr &y) { return sqrt(x * x + y * y); }
...
inline Expr exp(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "exp_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "exp_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "exp_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr log(const Expr &x) {
  ...
  if (x.type() == Float(64)) {
    return Internal::Call::make(Float(64), "log_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    return Internal::Call::make(Float(16), "log_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    return Internal::Call::make(Float(32), "log_f32", {cast<float>(x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr pow(Expr x, Expr y) {
  ...
  if (x.type() == Float(64)) {
    y = cast<double>(y);
    return Internal::Call::make(Float(64), "pow_f64", {x, y},
                                Internal::Call::PureExtern);
  } else if (x.type() == Float(16)) {
    y = cast<float16_t>(y);
    return Internal::Call::make(Float(16), "pow_f16", {x, y},
                                Internal::Call::PureExtern);
  } else {
    x = cast<float>(x);
    y = cast<float>(y);
    return Internal::Call::make(Float(32), "pow_f32", {x, y},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr fast_inverse(const Expr &x) {
  user_assert(x.type() == Float(32))
      << "fast_inverse only takes float arguments\n";
  return Internal::Call::make(x.type(), "fast_inverse_f32", {x},
                              Internal::Call::PureExtern);
}
...
inline Expr fast_inverse_sqrt(const Expr &x) {
  user_assert(x.type() == Float(32))
      << "fast_inverse_sqrt only takes float arguments\n";
  return Internal::Call::make(x.type(), "fast_inverse_sqrt_f32", {x},
                              Internal::Call::PureExtern);
}
...
inline Expr floor(const Expr &x) {
  ...
  if (x.type().element_of() == Float(64)) {
    return Internal::Call::make(x.type(), "floor_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type().element_of() == Float(16)) {
    return Internal::Call::make(Float(16), "floor_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    Type t = Float(32, x.type().lanes());
    return Internal::Call::make(t, "floor_f32", {cast(t, x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr ceil(const Expr &x) {
  ...
  if (x.type().element_of() == Float(64)) {
    return Internal::Call::make(x.type(), "ceil_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type().element_of() == Float(16)) {
    return Internal::Call::make(Float(16), "ceil_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    Type t = Float(32, x.type().lanes());
    return Internal::Call::make(t, "ceil_f32", {cast(t, x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr round(const Expr &x) {
  ...
  if (x.type().element_of() == Float(64)) {
    return Internal::Call::make(Float(64), "round_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type().element_of() == Float(16)) {
    return Internal::Call::make(Float(16), "round_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    Type t = Float(32, x.type().lanes());
    return Internal::Call::make(t, "round_f32", {cast(t, x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr trunc(const Expr &x) {
  ...
  if (x.type().element_of() == Float(64)) {
    return Internal::Call::make(Float(64), "trunc_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type().element_of() == Float(16)) {
    return Internal::Call::make(Float(16), "trunc_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    Type t = Float(32, x.type().lanes());
    return Internal::Call::make(t, "trunc_f32", {cast(t, x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr is_nan(const Expr &x) {
  ...
  if (x.type().element_of() == Float(64)) {
    return Internal::Call::make(t, "is_nan_f64", {x},
                                Internal::Call::PureExtern);
  } else if (x.type().element_of() == Float(64)) {
    return Internal::Call::make(t, "is_nan_f16", {x},
                                Internal::Call::PureExtern);
  } else {
    Type ft = Float(32, x.type().lanes());
    return Internal::Call::make(t, "is_nan_f32", {cast(ft, x)},
                                Internal::Call::PureExtern);
  }
}
...
inline Expr reinterpret(Type t, const Expr &e) {
  ...
  user_assert(from_bits == to_bits)
      << "Reinterpret cast from type " << e.type() << " which has " << from_bits
      << " bits, to type " << t << " which has " << to_bits << " bits\n";
  return Internal::Call::make(t, Internal::Call::reinterpret, {e},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr operator&(Expr x, Expr y) {
  ...
  user_assert(x.type().is_int() || x.type().is_uint())
      << "The first argument to bitwise and must be an integer or unsigned "
         "integer";
  user_assert(y.type().is_int() || y.type().is_uint())
      << "The second argument to bitwise and must be an integer or unsigned "
         "integer";
  ...
  return Internal::Call::make(x.type(), Internal::Call::bitwise_and, {x, y},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr operator|(Expr x, Expr y) {
  ...
  user_assert(x.type().is_int() || x.type().is_uint())
      << "The first argument to bitwise or must be an integer or unsigned "
         "integer";
  user_assert(y.type().is_int() || y.type().is_uint())
      << "The second argument to bitwise or must be an integer or unsigned "
         "integer";
  // First widen or narrow, then bitcast.
  if (y.type().bits() != x.type().bits()) {
    y = cast(y.type().with_bits(x.type().bits()), y);
  ...
  return Internal::Call::make(x.type(), Internal::Call::bitwise_or, {x, y},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr operator^(Expr x, Expr y) {
  ...
  user_assert(x.type().is_int() || x.type().is_uint())
      << "The first argument to bitwise xor must be an integer or unsigned "
         "integer";
  user_assert(y.type().is_int() || y.type().is_uint())
      << "The second argument to bitwise xor must be an integer or unsigned "
         "integer";
  // First widen or narrow, then bitcast.
  if (y.type().bits() != x.type().bits()) {
    y = cast(y.type().with_bits(x.type().bits()), y);
  ...
  return Internal::Call::make(x.type(), Internal::Call::bitwise_xor, {x, y},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr operator~(const Expr &x) {
  ...
  return Internal::Call::make(x.type(), Internal::Call::bitwise_not, {x},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr operator<<(Expr x, Expr y) {
  ...
  user_assert(!x.type().is_float())
      << "First argument to shift left is a float: " << x << "\n";
  user_assert(!y.type().is_float())
      << "Second argument to shift left is a float: " << y << "\n";
  Internal::match_types(x, y);
  return Internal::Call::make(x.type(), Internal::Call::shift_left, {x, y},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr operator>>(Expr x, Expr y) {
  ...
  user_assert(!x.type().is_float())
      << "First argument to shift right is a float: " << x << "\n";
  user_assert(!y.type().is_float())
      << "Second argument to shift right is a float: " << y << "\n";
  Internal::match_types(x, y);
  return Internal::Call::make(x.type(), Internal::Call::shift_right, {x, y},
                              Internal::Call::PureIntrinsic);
}
inline Expr operator>>(const Expr &x, int y) {
  Internal::check_representable(x.type(), y);
...
inline Expr popcount(const Expr &x) {
  ...
  return Internal::Call::make(x.type(), Internal::Call::popcount, {x},
                              Internal::Call::PureIntrinsic);
}
...
inline Expr div_round_to_zero(Expr x, Expr y) {
  ...
  user_assert(x.type().is_int())
      << "First argument to div_round_to_zero is not an integer: " << x << "\n";
  user_assert(y.type().is_int())
      << "Second argument to div_round_to_zero is not an integer: " << y
      << "\n";
  return Internal::Call::make(x.type(), Internal::Call::div_round_to_zero,
                              {x, y}, Internal::Call::PureIntrinsic);
}
...
inline Expr mod_round_to_zero(Expr x, Expr y) {
  ...
  user_assert(x.type().is_int())
      << "First argument to mod_round_to_zero is not an integer: " << x << "\n";
  user_assert(y.type().is_int())
      << "Second argument to mod_round_to_zero is not an integer: " << y
      << "\n";
...
inline Expr random_float(const Expr &seed = Expr()) {
  ...
  if (seed.defined()) {
    user_assert(seed.type() == Int(32))
        << "The seed passed to random_float must have type Int(32), but "
           "instead is "
  ...
  return Internal::Call::make(Float(32), Internal::Call::random, args,
                              Internal::Call::PureIntrinsic);
}
...
inline Expr random_uint(const Expr &seed = Expr()) {
  ...
  if (seed.defined()) {
    user_assert(seed.type() == Int(32) || seed.type() == UInt(32))
        << "The seed passed to random_int must have type Int(32) or UInt(32), "
           "but instead is "
        << seed << " of type " << seed.type() << "\n";
    args.push_back(seed);
  }
  ...
  return Internal::Call::make(UInt(32), Internal::Call::random, args,
                              Internal::Call::PureIntrinsic);
}
...
template <typename... Args>
inline NO_INLINE Expr print_when(const Expr &condition, const Expr &a,
                                 Args &&... args) {
  std::vector<Expr> collected_args = {a};
  Internal::collect_print_args(collected_args, std::forward<Args>(args)...);
...
template <typename... Args>
inline NO_INLINE Expr require(const Expr &condition, const Expr &value,
                              Args &&... args) {
...
inline Expr undef(Type t) {
  return Internal::Call::make(t, Internal::Call::undef, std::vector<Expr>(),
                              Internal::Call::PureIntrinsic);
}
...
inline Expr likely(const Expr &e) {
  return Internal::Call::make(e.type(), Internal::Call::likely, {e},
                              Internal::Call::PureIntrinsic);
}
