...
CodeGenAOCL::CodeGenAOCL() {
    restrict_keyword_ = "restrict";
}

void CodeGenAOCL::InitFuncState(LoweredFunc f) {
...
void CodeGenAOCL::BindThreadIndex(const IterVar& iv) {
...
void CodeGenAOCL::PrintVecAddr(const Variable* buffer, Type t,
...
std::string CodeGenAOCL::GetVecLoad(
...
void CodeGenAOCL::PrintVecStore(const Variable* buffer,
                                  Type t, Expr base,
...
void CodeGenAOCL::PrintStorageSync(const Call* op) {
...
void CodeGenAOCL::VisitExpr_(const Broadcast* op, std::ostream& os) {   // NOLINT(*)
...
void CodeGenAOCL::VisitExpr_(const Select * op, std::ostream& os ) { // NOINT(*)
    os << "(";
