...
test = 1
if(test==0):
  test_wrapper("model.hdf5","nnvm","keras","digitrec",x_train,y_train,(10,10),(784,),10)
elif(test==1):
  test_wrapper("model.hdf5","relay","keras","digitrec",x_train,y_train,(10,10),{'input_1' : (10,784)})
elif(test==2):
