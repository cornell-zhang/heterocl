...
void CodeGenCUDA::Init(bool output_ssa) {
  ...
  CHECK_EQ(vid_global_barrier_state_,
...
void CodeGenCUDA::PrintVecBinaryOp(const std::string& op, Type t, Expr lhs,
...
void CodeGenCUDA::PrintVecElemLoad(const std::string& vec, Type t, int i,
...
void CodeGenCUDA::PrintVecElemStore(const std::string& vec, Type t, int i,
...
void CodeGenCUDA::PrintStorageScope(const std::string& scope,
                                    std::ostream& os) {  // NOLINT(*)
...
void CodeGenCUDA::VisitExpr_(const Broadcast* op,
                             std::ostream& os) {  // NOLINT(*)
