...
def add_sub_rule():
    ...
    uint_rules = {
        ...
        (UInt, Fixed) : lambda t1, t2: Fixed(max(t1.bits + 1, t2.bits-t2.fracs) + t2.fracs + 1, t2.fracs),
        (UInt, UFixed) : lambda t1, t2: UFixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs + 1, t2.fracs),
    ...
    index_rules = {
        ...
        (Index, Fixed) : lambda t1, t2: Fixed(max(t1.bits + 1, t2.bits-t2.fracs) + t2.fracs + 1, t2.fracs),
        (Index, UFixed) : lambda t1, t2: UFixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs + 1, t2.fracs),
        (Index, Float) : lambda t1, t2: t2,
    }
    fixed_rules = {
        (Fixed, Int) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs + 1, t1.fracs),
        (Fixed, UInt) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits + 1) + t1.fracs + 1, t1.fracs),
        (Fixed, Index) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits + 1) + t1.fracs + 1, t1.fracs),
        (Fixed, Fixed) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs) + 1, max(t1.fracs, t2.fracs)),
        (Fixed, UFixed) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs + 1) + max(t1.fracs, t2.fracs) + 1, max(t1.fracs, t2.fracs)),
        (Fixed, Float) : lambda t1, t2 : t2,
    }
    ufixed_rules = {
        (UFixed, Int) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs + 1, t2.bits) + t1.fracs + 1, t1.fracs),
        (UFixed, UInt) : lambda t1, t2 : UFixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs + 1, t1.fracs),
        (UFixed, Index) : lambda t1, t2 : UFixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs + 1, t1.fracs),
        (UFixed, Fixed) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs + 1, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs) + 1, max(t1.fracs, t2.fracs)),
        (UFixed, UFixed) : lambda t1, t2 : UFixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs) + 1, max(t1.fracs, t2.fracs)),
...
def mul_rule():
    ...
    uint_rules = {
        ...
        (UInt, UFixed) : lambda t1, t2: UFixed(t1.bits + t2.bits, max(t1.fracs, t2.fracs)),
    ...
    index_rules = {
        ...
        (Index, Index): lambda t1, t2: Index(),
        (Index, Fixed) : lambda t1, t2: Fixed(t1.bits + t2.bits, max(t1.fracs, t2.fracs)),
        (Index, UFixed) : lambda t1, t2: UFixed(t1.bits + t2.bits, max(t1.fracs, t2.fracs)),
...
def div_rule():
    ...
    fixed_rules = {
        ...
        (Fixed, Fixed) : lambda t1, t2 : Fixed(t1.bits + t2.bits, t2.bits - t2.fracs + t1.fracs),
        (Fixed, UFixed) : lambda t1, t2 : Fixed(t1.bits + t2.bits + 1, t2.bits - t2.fracs + t1.fracs),
        (Fixed, Float) : lambda t1, t2 : t2,
    }
    ufixed_rules = {
        ...
        (UFixed, Fixed) : lambda t1, t2 : Fixed(t1.bits + t2.bits, t2.bits - t2.fracs + t1.fracs),
        (UFixed, UFixed) : lambda t1, t2 : UFixed(t1.bits + t2.bits, t2.bits - t2.fracs + t1.fracs),
        (UFixed, Float) : lambda t1, t2 : t2,
    }
    float_rules = {
        (Float, Int) : lambda t1, t2 : t1,
...
def mod_rule():
    ...
    int_rules = {
        ...
        (Int, Fixed) : lambda t1, t2: Fixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs, t2.fracs),
        (Int, UFixed) : lambda t1, t2: Fixed(max(t1.bits, t2.bits-t2.fracs + 1) + t2.fracs, t2.fracs),
        (Int, Float) : lambda t1, t2: t2,
    }
    uint_rules = {
        ...
        (UInt, Fixed) : lambda t1, t2: Fixed(max(t1.bits + 1, t2.bits-t2.fracs) + t2.fracs, t2.fracs),
        (UInt, UFixed) : lambda t1, t2: UFixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs, t2.fracs),
        (UInt, Float) : lambda t1, t2: t2,
    }
    index_rules = {
        ...
        (Index, Index): lambda t1, t2: Index(),
        (Index, Fixed) : lambda t1, t2: Fixed(max(t1.bits + 1, t2.bits-t2.fracs) + t2.fracs, t2.fracs),
        (Index, UFixed) : lambda t1, t2: UFixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs, t2.fracs),
        (Index, Float) : lambda t1, t2: t2,
    }
    fixed_rules = {
        (Fixed, Int) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs, t1.fracs),
        (Fixed, UInt) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits + 1) + t1.fracs, t1.fracs),
        (Fixed, Index) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits + 1) + t1.fracs, t1.fracs),
        (Fixed, Fixed) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)),
        (Fixed, UFixed) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs + 1) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)),
        (Fixed, Float) : lambda t1, t2 : t2,
    }
    ufixed_rules = {
        (UFixed, Int) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs + 1, t2.bits) + t1.fracs, t1.fracs),
        (UFixed, UInt) : lambda t1, t2 : UFixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs, t1.fracs),
        (UFixed, Index) : lambda t1, t2 : UFixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs, t1.fracs),
        (UFixed, Fixed) : lambda t1, t2 : Fixed(max(t1.bits - t1.fracs + 1, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)),
        (UFixed, UFixed) : lambda t1, t2 : UFixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)),
        (UFixed, Float) : lambda t1, t2 : t2,
    }
    float_rules = {
        (Float, Int) : lambda t1, t2 : t1,
...
def cmp_rule():
    ...
    int_rules = {
        ...
        (Int, Fixed) : lambda t1, t2: (Fixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs, t2.fracs), UInt(1)),
        (Int, UFixed) : lambda t1, t2: (Fixed(max(t1.bits, t2.bits-t2.fracs + 1) + t2.fracs, t2.fracs), UInt(1)),
    ...
    uint_rules = {
        ...
        (UInt, Fixed) : lambda t1, t2: (Fixed(max(t1.bits + 1, t2.bits-t2.fracs) + t2.fracs, t2.fracs), UInt(1)),
        (UInt, UFixed) : lambda t1, t2: (UFixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs, t2.fracs), UInt(1)),
    ...
    index_rules = {
        ...
        (Index, Fixed) : lambda t1, t2: (Fixed(max(t1.bits + 1, t2.bits-t2.fracs) + t2.fracs, t2.fracs), UInt(1)),
        (Index, UFixed) : lambda t1, t2: (UFixed(max(t1.bits, t2.bits-t2.fracs) + t2.fracs, t2.fracs), UInt(1)),
        (Index, Float) : lambda t1, t2: (t2, UInt(1)),
    }
    fixed_rules = {
        (Fixed, Int) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs, t1.fracs), UInt(1)),
        (Fixed, UInt) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs, t2.bits + 1) + t1.fracs, t1.fracs), UInt(1)),
        (Fixed, Index) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs, t2.bits + 1) + t1.fracs, t1.fracs), UInt(1)),
        (Fixed, Fixed) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)), UInt(1)),
        (Fixed, UFixed) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs + 1) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)), UInt(1)),
        (Fixed, Float) : lambda t1, t2 : (t2, UInt(1)),
    }
    ufixed_rules = {
        (UFixed, Int) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs + 1, t2.bits) + t1.fracs, t1.fracs), UInt(1)),
        (UFixed, UInt) : lambda t1, t2 : (UFixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs, t1.fracs), UInt(1)),
        (UFixed, Index) : lambda t1, t2 : (UFixed(max(t1.bits - t1.fracs, t2.bits) + t1.fracs, t1.fracs), UInt(1)),
        (UFixed, Fixed) : lambda t1, t2 : (Fixed(max(t1.bits - t1.fracs + 1, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)), UInt(1)),
        (UFixed, UFixed) : lambda t1, t2 : (UFixed(max(t1.bits - t1.fracs, t2.bits - t2.fracs) + max(t1.fracs, t2.fracs), max(t1.fracs, t2.fracs)), UInt(1)),
