...
class CodeBuilder(object):
    ...
    of CodeBuilder. A block formed within a CodeBuilder will be a
    ...
    input_stages : set(Tensor)
        A set of tensors that are the input to the CodeBuilder.

    """
    _current = []
    """Store all living CodeBuilder. The newest is at the end."""
