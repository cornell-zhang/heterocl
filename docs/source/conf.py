...
latex_documents = [
    (master_doc, "heterocl.tex", "heterocl Documentation", "seanlatias", "manual"),
]
...
man_pages = [(master_doc, "heterocl", "heterocl Documentation", [author], 1)]
