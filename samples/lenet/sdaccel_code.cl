__kernel void default_function(__global float* input_image, __global float* weight_conv1, __global float* weight_conv2, __global float* weight_fc1, __global float* weight_fc2, __global float* lenet) {
  __local float conv2d[11520000];
        ...
        for (int xx = 0; xx < 24; ++xx) {
          ...
          for (int ra15 = 0; ra15 < 5; ++ra15) {
            for (int ra16 = 0; ra16 < 5; ++ra16) {
              reducer6 = ((input_image[(((xx + ra16) + ((yy + ra15) * 28)) + (nn * 784))] * weight_conv1[((ra16 + (ra15 * 5)) + (ff * 25))]) + reducer6);
            }
          }
          conv2d[(((xx + (yy * 24)) + (ff * 576)) + (nn * 11520))] = reducer6;
        }
      }
    }
  }
  __local float tanh1[11520000];
  ...
  __local float max_pool[2880000];
        ...
        for (int w = 0; w < 12; ++w) {
          ...
          for (int ra17 = 0; ra17 < 2; ++ra17) {
            for (int ra18 = 0; ra18 < 2; ++ra18) {
              reducer7 = max(tanh1[(((((w * 2) + ra18) + (((h * 2) + ra17) * 24)) + (c * 576)) + (i * 11520))], reducer7);
            }
          }
          max_pool[(((w + (h * 12)) + (c * 144)) + (i * 2880))] = reducer7;
        }
      }
    }
  }
  __local float conv2d1[3200000];
          ...
          for (int ra19 = 0; ra19 < 20; ++ra19) {
            for (int ra20 = 0; ra20 < 5; ++ra20) {
              for (int ra21 = 0; ra21 < 5; ++ra21) {
                reducer8 = ((max_pool[((((xx1 + ra21) + ((yy1 + ra20) * 12)) + (ra19 * 144)) + (nn1 * 2880))] * weight_conv2[(((ra21 + (ra20 * 5)) + (ra19 * 25)) + (ff1 * 500))]) + reducer8);
              }
            }
          }
          conv2d1[(((xx1 + (yy1 * 8)) + (ff1 * 64)) + (nn1 * 3200))] = reducer8;
        }
      }
    }
  }
  __local float tanh2[3200000];
  ...
  __local float max_pool1[800000];
        ...
        for (int w1 = 0; w1 < 4; ++w1) {
          ...
          for (int ra22 = 0; ra22 < 2; ++ra22) {
            for (int ra23 = 0; ra23 < 2; ++ra23) {
              reducer9 = max(tanh2[(((((w1 * 2) + ra23) + (((h1 * 2) + ra22) * 8)) + (c1 * 64)) + (i1 * 3200))], reducer9);
            }
          }
          max_pool1[(((w1 + (h1 * 4)) + (c1 * 16)) + (i1 * 800))] = reducer9;
        }
      }
    }
  }
  __local float compute3[800000];
  for (int i2 = 0; i2 < 1000; ++i2) {
    for (int j = 0; j < 800; ++j) {
      compute3[(j + (i2 * 800))] = max_pool1[((((((j / 4) % 4) * 4) + (j % 4)) + ((j / 16) * 16)) + (i2 * 800))];
    }
  }
  __local float dense[500000];
  for (int i3 = 0; i3 < 1000; ++i3) {
    for (int j1 = 0; j1 < 500; ++j1) {
      __local float reducer10;
      reducer10 = 0.000000e+00f;
      for (int ra24 = 0; ra24 < 800; ++ra24) {
        reducer10 = ((compute3[(ra24 + (i3 * 800))] * weight_fc1[(ra24 + (j1 * 800))]) + reducer10);
      }
      dense[(j1 + (i3 * 500))] = reducer10;
    }
  }
  __local float tanh3[500000];
  ...
  __local float dense1[10000];
  for (int i4 = 0; i4 < 1000; ++i4) {
    for (int j2 = 0; j2 < 10; ++j2) {
      __local float reducer11;
      reducer11 = 0.000000e+00f;
      for (int ra25 = 0; ra25 < 500; ++ra25) {
        reducer11 = ((tanh3[(ra25 + (i4 * 500))] * weight_fc2[(ra25 + (j2 * 500))]) + reducer11);
      }
      dense1[(j2 + (i4 * 10))] = reducer11;
    }
  }
  __local float compute4[1000];
  for (int i5 = 0; i5 < 1000; ++i5) {
    __local int max;
    max = 0;
    for (int ra26 = 0; ra26 < 10; ++ra26) {
      max = ((int)max(dense1[(ra26 + (i5 * 10))], ((float)max)));
    }
    compute4[i5] = ((float)max);
  }
  __local float compute5[1000];
  for (int i6 = 0; i6 < 1000; ++i6) {
    __local int sum;
    sum = 0;
    for (int ra27 = 0; ra27 < 10; ++ra27) {
      sum = ((int)(exp(((double)(dense1[(ra27 + (i6 * 10))] - compute4[i6]))) + ((double)sum)));
    }
    compute5[i6] = ((float)sum);
  }
  __local float update1;
  for (int i7 = 0; i7 < 1000; ++i7) {
    for (int j3 = 0; j3 < 10; ++j3) {
      lenet[(j3 + (i7 * 10))] = ((float)(exp(((double)(dense1[(j3 + (i7 * 10))] - compute4[i7]))) / ((double)compute5[i7])));
    }
  }
}
