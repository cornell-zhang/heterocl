...
void default_function(float input_image[1000][1][28][28], float weight_conv1[20][1][5][5], float weight_conv2[50][20][5][5], float weight_fc1[500][800], float weight_fc2[10][500], float lenet[1000][10]) {
        ...
        for (ap_int<32> xx = 0; xx < 24; ++xx) {
          ...
          for (ap_int<32> ra29 = 0; ra29 < 5; ++ra29) {
            for (ap_int<32> ra30 = 0; ra30 < 5; ++ra30) {
              reducer12 = ((input_image[nn][0][(yy + ra29)][(xx + ra30)] * weight_conv1[ff][0][ra29][ra30]) + reducer12);
            }
          }
          conv2d[nn][ff][yy][xx] = reducer12;
        }
      }
    }
  }
    ...
    for (ap_int<32> args0 = 0; args0 < 20; ++args0) {
      for (ap_int<32> args1 = 0; args1 < 24; ++args1) {
        for (ap_int<32> args2 = 0; args2 < 24; ++args2) {
          tanh1[args][args0][args1][args2] = ((float)tanh(((double)conv2d[args][args0][args1][args2])));
        }
      }
    }
  }
  float max_pool[1000][20][12][12];
        ...
        for (ap_int<32> w = 0; w < 12; ++w) {
          ...
          for (ap_int<32> ra31 = 0; ra31 < 2; ++ra31) {
            for (ap_int<32> ra32 = 0; ra32 < 2; ++ra32) {
              reducer13 = std::max(tanh1[i][c][((h * 2) + ra31)][((w * 2) + ra32)], reducer13);
            }
          }
          max_pool[i][c][h][w] = reducer13;
        }
      }
    }
  }
          ...
          for (ap_int<32> ra33 = 0; ra33 < 20; ++ra33) {
            for (ap_int<32> ra34 = 0; ra34 < 5; ++ra34) {
              for (ap_int<32> ra35 = 0; ra35 < 5; ++ra35) {
                reducer14 = ((max_pool[nn1][ra33][(yy1 + ra34)][(xx1 + ra35)] * weight_conv2[ff1][ra33][ra34][ra35]) + reducer14);
              }
            }
          }
          conv2d1[nn1][ff1][yy1][xx1] = reducer14;
        }
      }
    }
  }
    ...
    for (ap_int<32> args01 = 0; args01 < 50; ++args01) {
      for (ap_int<32> args11 = 0; args11 < 8; ++args11) {
        for (ap_int<32> args21 = 0; args21 < 8; ++args21) {
          tanh2[args3][args01][args11][args21] = ((float)tanh(((double)conv2d1[args3][args01][args11][args21])));
        }
      }
    }
  }
  float max_pool1[1000][50][4][4];
        ...
        for (ap_int<32> w1 = 0; w1 < 4; ++w1) {
          ...
          for (ap_int<32> ra36 = 0; ra36 < 2; ++ra36) {
            for (ap_int<32> ra37 = 0; ra37 < 2; ++ra37) {
              reducer15 = std::max(tanh2[i1][c1][((h1 * 2) + ra36)][((w1 * 2) + ra37)], reducer15);
            }
          }
          max_pool1[i1][c1][h1][w1] = reducer15;
        }
      }
    }
  }
  float compute6[1000][800];
  ...
  for (ap_int<32> i3 = 0; i3 < 1000; ++i3) {
    for (ap_int<32> j1 = 0; j1 < 500; ++j1) {
      ...
      for (ap_int<32> ra38 = 0; ra38 < 800; ++ra38) {
        reducer16 = ((compute6[i3][ra38] * weight_fc1[j1][ra38]) + reducer16);
      }
      dense[i3][j1] = reducer16;
    }
  }
  float tanh3[1000][500];
  for (ap_int<32> args4 = 0; args4 < 1000; ++args4) {
    for (ap_int<32> args02 = 0; args02 < 500; ++args02) {
      tanh3[args4][args02] = ((float)tanh(((double)dense[args4][args02])));
    }
  }
  ...
  for (ap_int<32> i4 = 0; i4 < 1000; ++i4) {
    for (ap_int<32> j2 = 0; j2 < 10; ++j2) {
      ...
      for (ap_int<32> ra39 = 0; ra39 < 500; ++ra39) {
        reducer17 = ((tanh3[i4][ra39] * weight_fc2[j2][ra39]) + reducer17);
      }
      dense1[i4][j2] = reducer17;
    }
  }
  float compute7[1000];
  for (ap_int<32> i5 = 0; i5 < 1000; ++i5) {
    ...
    for (ap_int<32> ra40 = 0; ra40 < 10; ++ra40) {
      max = ((ap_int<32>)std::max(dense1[i5][ra40], ((float)max)));
    }
    compute7[i5] = ((float)max);
  }
  float compute8[1000];
  for (ap_int<32> i6 = 0; i6 < 1000; ++i6) {
    ...
    for (ap_int<32> ra41 = 0; ra41 < 10; ++ra41) {
      sum = ((ap_int<32>)(exp(((double)(dense1[i6][ra41] - compute7[i6]))) + ((double)sum)));
    }
    compute8[i6] = ((float)sum);
  }
  float update2;
  for (ap_int<32> i7 = 0; i7 < 1000; ++i7) {
    for (ap_int<32> j3 = 0; j3 < 10; ++j3) {
      lenet[i7][j3] = ((float)(exp(((double)(dense1[i7][j3] - compute7[i7]))) / ((double)compute8[i7])));
    }
  }
}
