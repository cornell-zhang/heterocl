    ...
    for (int t_inner = 0; t_inner < 32; ++t_inner) {
      ...
      for (int i = 0; i < 129; ++i) {
        for (int j = 0; j < 129; ++j) {
          ...
          if ((i != 0) && (j != 0)) {
            trace_back[0] = ((int)(((long)matrix[((j + (i * 129)) + -130)]) + ((long)((seqAs[((i + (((t_outer * 32) + t_inner) * 128)) + -1)] == seqBs[((j + (((t_outer * 32) + t_inner) * 128)) + -1)]) ? 1 : -4))));
      ...
      while (((curr_i != next_i) || (curr_j != next_j))) {
        ...
        if (next_i == curr_i) {
          ...
          a = ((int)seqAs[((curr_i + (((t_outer * 32) + t_inner) * 128)) + -1)]);
        }
        if (next_j == curr_j) {
          b = 0;
        } else {
          b = ((int)seqBs[((curr_j + (((t_outer * 32) + t_inner) * 128)) + -1)]);
        }
        outAs[(tick + (((t_outer * 32) + t_inner) * 256))] = ((unsigned char)a);
        outBs[(tick + (((t_outer * 32) + t_inner) * 256))] = ((unsigned char)b);
        curr_i = next_i;
        curr_j = next_j;
        int act2;
