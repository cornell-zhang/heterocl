...
target.config("vivado_hls", mode="csyn")
...
def run_tests():
    ...
    hcl_m1_for = hcl.asarray(np.zeros((m, n)), Dtype)
    hcl_m2_for = hcl.asarray(np.zeros((m, n)), Dtype)
    hcl_m3_for = hcl.asarray(np.zeros((m,n)), Dtype)
    
    hcl_m1_for_if = hcl.asarray(np.zeros((m, n)), Dtype)
    hcl_m2_for_if = hcl.asarray(np.zeros((m, n)), Dtype)
    hcl_m3_for_if = hcl.asarray(np.zeros((m,n)), Dtype)
    
    hcl_m1_mem = hcl.asarray(np.zeros((m, n)), Dtype)
    hcl_m2_mem = hcl.asarray(np.zeros((m, n)), Dtype)
    hcl_m3_mem = hcl.asarray(np.zeros((m,n)), Dtype)
