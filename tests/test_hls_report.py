...
def sobel():
    ...
    def sobel_kernel(imgF, Gx, Gy):
        ...
        A = hcl.compute(
            (height + 2, width + 2),
            lambda x, y: P[x][y][0] + P[x][y][1] + P[x][y][2],
            "A",
        )
        ...
        R = hcl.compute(
            (height, width),
            lambda x, y: hcl.sqrt(resX[x][y] * resX[x][y] + resY[x][y] * resY[x][y]),
            "R",
        )
...
def test_knn_digitrec(vhls):
    config = {
        ...
        "col": "Category",
        "info": "NoQuery",
        "loop_query": {"query": ["knn_update"], "name": "LoopQuery"},
        "column_query": {"query": ["Trip Count"], "name": "ColumnQuery"},
        "level_query": {"val": 0, "name": "LevelQuery"},
        "level_out_of_bound": {"val": [5, -2], "name": "LevelQueryOOB"},
        "multi_query": {
...
def test_kmeans(vhls):
    config = {
        ...
        "col": "Category",
        "info": "NoQuery",
        "loop_query": {"query": ["points_burst"], "name": "LoopQuery"},
        "column_query": {"query": ["Latency"], "name": "ColumnQuery"},
        "level_query": {"val": 0, "name": "LevelQuery"},
        "level_out_of_bound": {"val": [5, -2], "name": "LevelQueryOOB"},
        "multi_query": {
            "row_query": ["main_loop"],
...
def test_sobel(vhls):
    config = {
        ...
        "col": "Category",
        "info": "NoQuery",
        "loop_query": {"query": ["P", "A"], "name": "LoopQuery"},
        "column_query": {
            "query": [
                "Trip Count",
                "Latency",
        ...
        "level_query": {"val": 1, "name": "LevelQuery"},
        "level_out_of_bound": {"val": [5, -2], "name": "LevelQueryOOB"},
        "multi_query": {
            "row_query": ["P", "A"],
            "level_query": 1,
...
def test_sobel_partial(vhls):
    config = {
        ...
        "col": "Category",
        "info": "NoQuery",
        "loop_query": {"query": ["B", "D"], "name": "LoopQuery"},
        "column_query": {
            "query": [
                "Trip Count",
                "Latency",
        ...
        "level_query": {"val": 2, "name": "LevelQuery"},
        "level_out_of_bound": {"val": [5, -2], "name": "LevelQueryOOB"},
        "multi_query": {
            "row_query": ["B", "D"],
            "level_query": 1,
...
def test_canny(vhls):
    config = {
        ...
        "col": "Category",
        "info": "NoQuery",
        "loop_query": {"query": ["A", "Y"], "name": "LoopQuery"},
        "column_query": {
            "query": [
                "Trip Count",
                "Min Latency",
                "Max Latency",
                "Min Iteration Latency",
                "Max Iteration Latency",
                "Pipeline II",
                "Pipeline Depth",
            ],
            "name": "ColumnQuery",
...
def test_spam_filter(vhls):
    config = {
        ...
        "col": "Category",
        "info": "NoQuery",
        "loop_query": {"query": ["loop_x"], "name": "LoopQuery"},
        "column_query": {
            "query": [
                "Trip Count",
                "Latency",
