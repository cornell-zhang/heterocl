...
def test_ap_int():
	...
	code = hcl.build(s, target='insider')
	assert "ST_Queue<APP_Data>" in code
...
def test_reorder():
	...
	code2 = hcl.build(s, target='insider')
...
def test_binary_conv():
    ...
    code = hcl.build(s, target='insider'); print(code)
