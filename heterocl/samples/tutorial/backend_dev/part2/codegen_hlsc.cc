...
void CodeGenHLSC::Init() {
    ;
}

void CodeGenHLSC::InitFuncState(LoweredFunc f) {
...
std::string CodeGenHLSC::Finish() {
  return decl_stream.str() + stream.str();
}

void CodeGenHLSC::PrintExpr(const Expr& n, std::ostream& os) {  // NOLINT(*)
  VisitExpr(n, os);
}

void CodeGenHLSC::PrintSSAAssign(
...
// Print a reference expression to a buffer.
std::string CodeGenHLSC::GetStructRef(
...
bool CodeGenHLSC::HandleTypeMatch(const Variable* buf_var, Type t) const {
  auto it = handle_data_type_.find(buf_var);
  if (it == handle_data_type_.end()) return false;
  return it->second == t;
}

void CodeGenHLSC::RegisterHandleType(const Variable* buf_var, Type t) {
  auto it = handle_data_type_.find(buf_var);
...
void CodeGenHLSC::PrintVecElemLoad(const std::string& vec,
                                Type t, int i,
                                std::ostream& os) {  // NOLINT(*)
  os << vec << ".s" << std::hex << i << std::dec;
}

void CodeGenHLSC::PrintVecElemStore(const std::string& vec,
                                 Type t, int i,
...
std::string CodeGenHLSC::GetVecLoad(
    Type t, const Variable* buffer, Expr base) {
  return GetBufferRef(t, buffer, base);
}

void CodeGenHLSC::PrintVecStore(const Variable* buffer,
                             Type t, Expr base,
                             const std::string& value) {
...
std::string CodeGenHLSC::CastFromTo(std::string value, Type from, Type target) {
...
void CodeGenHLSC::BindThreadIndex(const IterVar& iv) {
  LOG(FATAL) << "not implemented";
}

void CodeGenHLSC::PrintStorageSync(const Call* op) { // NOLINT(*)
}

void CodeGenHLSC::PrintStorageScope(const std::string& scope, std::ostream& os) { // NOLINT(*)
  CHECK_EQ(scope, "global");
}

void CodeGenHLSC::PrintType(Type t, std::ostream& os) {  // NOLINT(*)
  CHECK_EQ(t.lanes(), 1)
...
inline void PrintConst(const IntImm* op, std::ostream& os, CodeGenHLSC* p) { // NOLINT(*)
  if (op->type == Int(32)) {
...
inline void PrintConst(const UIntImm* op, std::ostream& os, CodeGenHLSC* p) { // NOLINT(*)
  if (op->type == UInt(32)) {
    std::ostringstream temp;
    temp << op->value << "U";
    p->MarkConst(temp.str());
...
inline void PrintConst(const FloatImm* op, std::ostream& os, CodeGenHLSC* p) { // NOLINT(*)
  switch (op->type.bits()) {
    case 64: case 32: {
      std::ostringstream temp;
...
void CodeGenHLSC::VisitExpr_(const IntImm *op, std::ostream& os) {  // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeGenHLSC::VisitExpr_(const UIntImm *op, std::ostream& os) {  // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeGenHLSC::VisitExpr_(const FloatImm *op, std::ostream& os) { // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeGenHLSC::VisitExpr_(const StringImm *op, std::ostream& os) { // NOLINT(*)
  os << "\"" << op->value << "\"";
}
...
void CodeGenHLSC::VisitExpr_(const Cast *op, std::ostream& os) {  // NOLINT(*)
  std::stringstream value;
  this->PrintExpr(op->value, value);
  os << CastFromTo(value.str(), op->value.type(), op->type);
}
void CodeGenHLSC::VisitExpr_(const Variable *op, std::ostream& os) {  // NOLINT(*)
  os << GetVarID(op);
}
void CodeGenHLSC::VisitExpr_(const Add *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "+", os, this);
}
void CodeGenHLSC::VisitExpr_(const Sub *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "-", os, this);
}
void CodeGenHLSC::VisitExpr_(const Mul *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "*", os, this);
}
void CodeGenHLSC::VisitExpr_(const Div *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "/", os, this);
}
void CodeGenHLSC::VisitExpr_(const Mod *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "%", os, this);
}
...
void CodeGenHLSC::VisitExpr_(const EQ *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "==", os, this);
}
void CodeGenHLSC::VisitExpr_(const NE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "!=", os, this);
}
void CodeGenHLSC::VisitExpr_(const LT *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "<", os, this);
}
void CodeGenHLSC::VisitExpr_(const LE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "<=", os, this);
}
void CodeGenHLSC::VisitExpr_(const GT *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, ">", os, this);
}
void CodeGenHLSC::VisitExpr_(const GE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, ">=", os, this);
}
void CodeGenHLSC::VisitExpr_(const And *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "&&", os, this);
}
void CodeGenHLSC::VisitExpr_(const Or *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "||", os, this);
}
void CodeGenHLSC::VisitExpr_(const Not *op, std::ostream& os) {  // NOLINT(*)
  os << '!';
  PrintExpr(op->a, os);
}

void CodeGenHLSC::VisitExpr_(const Call *op, std::ostream& os) {  // NOLINT(*)
...
void CodeGenHLSC::PrintVecBinaryOp(
...
void CodeGenHLSC::VisitExpr_(const Load* op, std::ostream& os) {  // NOLINT(*)
...
void CodeGenHLSC::VisitStmt_(const Store* op) {
...
void CodeGenHLSC::VisitExpr_(const Let* op, std::ostream& os) {  // NOLINT(*)
  std::string value = PrintExpr(op->value);
  CHECK(!var_idmap_.count(op->var.get()));
  var_idmap_[op->var.get()] = value;
}

void CodeGenHLSC::VisitExpr_(const Ramp* op, std::ostream& os) {  // NOLINT(*)
...
void CodeGenHLSC::VisitExpr_(const Broadcast* op, std::ostream& os) {   // NOLINT(*)
  LOG(FATAL) << "Broadcast: not supported ";
}

void CodeGenHLSC::VisitExpr_(const Select* op, std::ostream& os) {  // NOLINT(*)
  os << "(";
...
void CodeGenHLSC::VisitStmt_(const AttrStmt* op) {
...
void CodeGenHLSC::VisitStmt_(const AssertStmt* op) {
...
void CodeGenHLSC::VisitStmt_(const Block *op) {
  PrintStmt(op->first);
  if (op->rest.defined()) PrintStmt(op->rest);
}

void CodeGenHLSC::VisitStmt_(const Evaluate *op) {
...
void CodeGenHLSC::VisitStmt_(const ProducerConsumer *op) {
  PrintStmt(op->body);
}
